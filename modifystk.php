...
<section class="category" id="category">
    <h1 class="heading">Admin Dashboard (Modify Record Data) <a href="cart.php" class="fas fa-user-circle"></a></h1>
...
include "db_conn.php";
    ...
    {
        $did = $_GET['delete_id'];
        $q= "DELETE FROM stock1 WHERE ITEM_ID = '$did';";
        // echo "$q";
        $r = mysqli_query($conn, $q);
        echo "Record Deleted with Item-id=$did";
    }
        ;
        if (isset($_SESSION['id'])) {
        ...
        while (($row = mysqli_fetch_array($result))) {
            ...
            $count++;{
                ...
                <td>$price</td>
                <td>
                <form action='modifystk.php' method='get'>
...
<!--
    <form action='modifystk.php' method='get'>
                        <input type='hidden' name='modify_id' value=$iid>
