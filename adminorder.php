...
<section class="category" id="category">
    <h1 class="heading">Admin Dashboard (Order Record)  <a href="cart.php" class="fas fa-user-circle"></a></h1>
        ...
        while (($row = mysqli_fetch_array($result))) {
            ...
            $count++;{
                ...
                <form action='adminorder.php' method='get'>
                        <input type='hidden' name='delete_id' value=$oid>
