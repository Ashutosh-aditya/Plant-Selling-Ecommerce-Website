...
if (isset($_POST['insert_product']))
{
    ...
    $qry = "insert into stock1 (ITEM_ID,ITEM_TITLE,	ITEM_CATEGORY,IN_STOCK1,IMG_ID,STATUS,PRICE)
    values ('$pdid','$ptitle','$pcat','$pstk','$pimg','$pstatus',$pprice)";
...
<section class="category" id="category">
    <h1 class="heading">Admin Dashboard (Insert Product) <a href="#" class="fas fa-user-circle"></a></h1>
    <?php
    if (isset($_SESSION['id'])) {
        ...
        <div>
            ...
            <input type='text' name='product_id' id='product_id' placeholder='Enter Product ID' class='input1' autocomplete='off' required='required'><br>
